      ...
      <div style={{
        ...
        <div style={{
          ...
          {mainSponsors.map((sponsor, index) => (
            <div key={index} style={{
              padding: isMobile ? '26px 18px' : (index === 0 ? '80px 60px' : '60px 40px'),
              ...
              cursor: 'pointer',
              transform: isMobile ? 'none' : (index === 0 ? 'scale(1.05)' : 'scale(1)')
            }}
            onMouseOver={(e) => {
              if (isMobile) return;
            ...
            onMouseOut={(e) => {
              ...
              <div style={{
                width: '100%',
                height: isMobile ? '140px' : (index === 0 ? '200px' : '150px'),
                backgroundColor: 'rgba(255, 255, 255, 0.9)',
                borderRadius: '15px',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: isMobile ? '18px' : (index === 0 ? '24px' : '20px'),
                fontWeight: '800',
                color: '#0a4a42',
                fontFamily: "'Inter', sans-serif",
              ...
              <div style={{
                fontSize: isMobile ? '15px' : (index === 0 ? '18px' : '16px'),
                fontWeight: '700',
                color: '#f5f1e8',
                fontFamily: "'Inter', sans-serif",
                opacity: 0.95
